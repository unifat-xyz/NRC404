...
impl Contract {
    ...
    pub fn is_owner(&self) -> bool {
        return env::predecessor_account_id() == self.owner_id;
    }
...
mod upgrade {
    ...
    pub extern "C" fn upgrade() {
        ...
        let nft_total_supply_method_name = b"nft_total_supply".to_vec();
        ...
        unsafe {
            ...
            sys::promise_batch_action_function_call(
                promise_id.clone(),
                nft_total_supply_method_name.len() as _,
                nft_total_supply_method_name.as_ptr() as _,
                empty_args.len() as _,
                empty_args.as_ptr() as _,
                0 as _,
